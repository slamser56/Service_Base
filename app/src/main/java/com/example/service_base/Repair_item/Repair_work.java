...
public class Repair_work {
    ...
    public static final String TAG_REPAIR_WORK = "repair_work";
    public static final String TAG_ID = "id_work";
    ...
    public static final String TAG_WORKER = "work_name";
    ...
    public Repair_work(int id_w, int price_w, String work_w, String worker_w, String date_w) {
        this.id_w = id_w;
